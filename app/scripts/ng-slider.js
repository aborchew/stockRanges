				...
				template:
					'<span ng-class="mainSliderClass" id="{{sliderTmplId}}">' +
						'<table><tr><td>' +
							...
							'<div class="jslider-label">{{options.dimension}}<span ng-bind-html="from"></span></div>' +
							'<div class="jslider-label jslider-label-to">{{options.dimension}}<span ng-bind-html="to"></span></div>' +

							'<div class="jslider-value">{{options.dimension}}<span></span></div>' +
							'<div class="jslider-value jslider-value-to">{{options.dimension}}<span></span></div>' +
